			...
			<main>
				...
				<section className="bg-blue bg-guide-image bg-cover bg-center bg-no-repeat">
					...
					>
						...
						<div
							className="absolute w-full max-w-[21.4375rem] max-h-[9.375rem] right-0 left-0 bottom-0 -mb-[4.6rem] mx-auto rounded-[.625rem] overflow-hidden shadow-[0px_10px_100px_0px_rgba(0,0,0,0.24)]
							tablet:-mb-[7.2rem] tablet:max-w-[35.625rem] tablet:max-h-[14.4375rem]
							xl:-mb-[9.9rem] xl:max-w-[48.125rem] xl:max-h-[19.9375rem]"
						>
							<svg
								className="absolute top-0 right-0 bottom-0 left-0 m-auto cursor-pointer z-10"
								width="70"
								height="70"
								viewBox="0 0 70 70"
								fill="none"
